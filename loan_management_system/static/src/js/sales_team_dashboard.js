odoo.define('loan_management_system.dashboard', function (require) {
"use strict";
...
var SalesTeamDashboardView = KanbanView.extend({
    ...
    render: function() {
        ...
        return this.fetch_data().then(function(result){
            ...
            var sales_dashboard = QWeb.render('loan_management_system.SalesDashboard', {
                widget: self,
                show_demo: self.show_demo,
                values: result,
            });
            console.log(result+'lllllllllllllllllll');
...
core.view_registry.add('sales_team_dashboards', SalesTeamDashboardView);
